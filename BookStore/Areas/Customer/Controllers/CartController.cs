...
namespace BookStore.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public async Task<IActionResult> IndexPOST()
        {
            ...
            ModelState.AddModelError(string.Empty, "Verification email envoyée. vauillez consultez votre boite de réception.");
        ...
        public IActionResult OrderConfirmation(int id)
        {
            ...
            try
            {
                var message = MessageResource.Create(
                    body: "Vous avez une nouvelle proposition de la part de Appli-taxi "+
                           "Cliquez sur le lien si dessous pour voir votre proposition https://localhost:44331/Customer/Proposals/Details?proposalId=" + id,
